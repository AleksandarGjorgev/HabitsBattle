        ...
        <footer className="footer h-max p-2 md:p-5 bg-gray-800 text-neutral-content bottom-0 left-0 right-0">
            ...
            <nav>
                <div class="p-4">
                    ...
                    <ul class="flex">
                        <li class="my-4"><a href="https://github.com/AleksandarGjorgev" aria-label="GITHUB" target="_blank" rel="noopener"
                                class="w-min flex items-center bg-indigo-400 px-1 py-1 rounded-md text-black hover:bg-violet-200 transition hover:-translate-y-1 mr-2"><svg
                        ...
                        <li class="my-4"><a href="https://www.linkedin.com/in/aleksandar-gjorgev/" aria-label="LINKEDIN" target="_blank" rel="noopener"
                                class="w-min flex items-center  bg-indigo-400 px-1 py-1 rounded-md text-black hover:bg-violet-200 transition hover:-translate-y-1 mr-2"><svg
